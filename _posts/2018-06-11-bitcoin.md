...
To the best of my knowledge, neccessary conditions for security of PoW blockchains don't yet exist. So if you're out to
...
Earlier versions of the paper used a rather unrealistic communication model.  
