...
variables are implemented. This is the implementation in [1], but I believe other tools have similar designs.  
...
means $$S$$ receives $$1000$$ requests per second (how are these requests generated is discussed next). 

> $$\langle A, N, T, C, O\rangle$$ represents the 
